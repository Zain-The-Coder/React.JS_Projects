function Paragraph() {
  ...
  return (
    <>
      {/* Container: Mobile pe width 90% aur center, Desktop pe w-85% aur original position */}
      <section className="flex flex-col md:flex-row justify-between font-[poppins] text-[11px] py-[40px] md:py-[70px] w-[90%] md:w-[85%] mx-auto md:ml-[5%] text-[#9595b4] gap-8 md:gap-4">
        
        {/* Section 1 */}
        <section className="w-full md:w-[22%]">
          <div>
            <h3 className="uppercase text-[15px] text-[#606060] font-semibold">How Daraz Transformed Online Shopping in Pakistan</h3>
            <p className="py-[10px]">How Daraz Transformed Online Shopping in Pakistan</p>
            <p>{firstDivPara}</p>
          </div>
          <div className="mt-4">
            <h3 className="uppercase text-[15px] text-[#606060] py-[5px] font-semibold">What Makes Us Different from Other Online Shopping Platforms?</h3>
            <p>
              <b className="text-[#9595b4] text-[12px]">Select from the Largest Online Marketplace in Pakistan </b> 
              <br />{miniPara}
            </p>
          </div>
        </section>
        ...
        <section className="w-full md:w-[22%]">
          <div>
            <h3 className="uppercase text-[15px] text-[#606060] font-semibold">Top Categories & Brands</h3>
            <p>{firstDivPara}</p>
          </div>
          <div className="mt-4">
        ...
        <section className="w-full md:w-[22%]">
          <div className="flex flex-col gap-4">
            <p><b>WOMEN'S FASHION</b><br />{firstDivPara}</p>
            <p><b>MEN'S FASHION</b><br />{miniPara}</p>
          </div>
        </section>
