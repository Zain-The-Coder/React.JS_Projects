...
function Login() {
  return (
    <>
      <section className="absolute top-[80px] left-1/2 -translate-x-1/2 w-[95%] sm:w-[80%] md:w-[60%] lg:w-[40%]
          xl:w-[35%] p-[25px] sm:p-[40px] bg-white rounded-[10px] z-40">
        <ClearIcon sx={{position: "absolute", top: "15px",right: "15px",cursor: "pointer",}}/>

        <div className="flex justify-center font-[poppins] mb-[20px]">
          <h2 className="text-[#9a9fad] border-r pr-[20px] sm:pr-[30px] cursor-pointer">Password</h2>
        ...
        <Button variant="contained" disableElevation
          sx={{ backgroundColor: "#f85606", color: "#fff", fontSize: { xs: "14px", sm: "16px" }, 
           padding: "10px", width: "100%", fontFamily: "poppins", borderRadius: "8px",
           "&:hover": {backgroundColor: "#d94a05",},}}>Login</Button>
