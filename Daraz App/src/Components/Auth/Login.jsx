    ...
    <>
      {isLogin ? (
        <section className="absolute top-[110px] left-1/2 -translate-x-1/2 w-[95%] sm:w-[80%] md:w-[60%] lg:w-[40%] xl:w-[35%] text-black p-[25px] sm:p-[40px] bg-white rounded-[10px] z-40">
          ...
          <div>
            <input
              className="w-full my-[15px] font-[poppins] h-12 text-[12px] border-2 border-gray-300 rounded-md pl-3 text-[#121212] focus:outline-none focus:border-blue-500"
              type="email"
              placeholder="Please Enter Your Email"
            />
            <input
              className="w-full font-[poppins] h-12 text-[12px] border-2 border-gray-300 rounded-md pl-3 text-[#121212] focus:outline-none focus:border-blue-500"
              type="password"
              placeholder="Please Enter Your Password"
            />
            <p className="text-[#9a9fad] mt-[10px] mb-[20px] font-[poppins] text-[11px] text-right cursor-pointer">
              Forgot Password ?
            </p>
          </div>
          ...
          <p className="text-center font-[poppins] text-[13px] sm:text-[14px] text-[#9a9fad] my-[10px]">
            ...
            <span
              onClick={() => {
                setIsLogin(false); // show signup inside modal
                setShowLogin(false);
                setShowSignup(true); // parent state
              }}
