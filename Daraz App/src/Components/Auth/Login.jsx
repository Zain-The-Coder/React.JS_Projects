...
function Login() {
  ...
  return (
    <>
      {isLogin ? (
        <section className="absolute top-[110px] left-1/2 -translate-x-1/2 w-[95%] sm:w-[80%] md:w-[60%] lg:w-[40%]
        xl:w-[35%] text-black p-[25px] sm:p-[40px] bg-white rounded-[10px] z-40">

          <ClearIcon onClick={() => setIsLogin(false)} sx={{ position: "absolute", top: "15px", right: "15px", cursor: "pointer" }}/>
          ...
          <Button variant="contained" disableElevation sx={{backgroundColor: "#f85606", color: "#fff", fontSize: { xs: "14px", sm: "16px" },
              padding: "10px", width: "100%", fontFamily: "poppins", borderRadius: "8px","&:hover": { backgroundColor: "#d94a05" },}}>
            Login</Button>

          <p className="text-center font-[poppins] text-[13px] sm:text-[14px] text-[#9a9fad] my-[10px]">
            Don't Have An Account ?
            <span onClick={() => setIsLogin(false)} className="text-blue-500 cursor-pointer"> Sign Up
            </span>
          </p>
